              ...
              <div className="p-6 flex-1 flex flex-col justify-between text-left">
                ...
                <ul className="text-sm text-gray-700 space-y-1 mb-4">
                  <li className="flex items-center gap-2">
                    ...
                    <span className="text-base">{property.size} m2</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#00332D] inline-block"></span>
                  ...
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#00332D] inline-block"></span>
                    <span className="text-base">{property.floor}.stāvs</span>
                  </li>
                </ul>
              ...
              <div className="grid md:grid-cols-2">
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    <span className="font-semibold">{selected.size}m2</span> · <span className="font-semibold">{selected.type}</span> · <span className="font-semibold">{selected.floor}.stāvs</span>
                  </p>
