  ...
  return (
    <section className="relative py-20 px-4 md:px-12 bg-white overflow-hidden">
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
        {/* Teksta bloks */}
        <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-lg p-8 max-w-[500px] w-full">
        ...
        {/* Bildes bloks */}
        <div className="relative w-full flex-grow aspect-[3/2] rounded-xl overflow-hidden">
          <Image
            src={data.imageUrl}
